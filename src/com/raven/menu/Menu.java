...
public class Menu extends javax.swing.JPanel {
    ...
    private void initMenu() {
        ...
        addMenu("Sales", "2", 1);
        addMenu("Customer", "3", 2);
        addMenu("Invoice", "4", 3);
        addMenu("Supplier", "5", 4);
        addMenu("Product", "6", 5);
        addMenu("Purchase", "7", 6);
        addMenu("PO/Bill", "8", 7);
        addMenu("Return's", "9", 8);
        addMenu("Account", "10", 9);
        addMenu("Employee", "11", 10);
        addMenu("Reports", "12", 11);
        addMenu("Setting", "13", 12);
